...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pk~mgwwQAKQ#Zb86KmfVRN_21nZPhM2kvTT1855umxdPbqP4fj5Vgl8",
...
BOT_NAME: process.env.BOT_NAME || "𝐃𝐊𝐀𝐑𝐋𝐓𝐄𝐂𝐇-𝐗𝐌𝐃",
STICKER_NAME: process.env.STICKER_NAME || "PK-XMD",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "254 116 4705",
OWNER_NAME: process.env.OWNER_NAME || "DIGIKING👑",
